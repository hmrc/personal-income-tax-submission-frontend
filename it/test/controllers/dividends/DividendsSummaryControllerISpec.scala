...
class DividendsSummaryControllerISpec extends IntegrationTest with ViewHelpers with DividendsDatabaseHelper {
  ...
  object AllExpectedEnglish extends CommonExpectedResults {
    ...
    val dividendsFromStocksAndSharesHiddenText = "Change Change dividends from stocks and shares"
    val dividendsStatusHiddenText = "Change Change dividends from UK companies"
    val dividendsAmountHiddenText = "Change Change amount of dividends from UK companies"
    val dividendsOtherStatusHiddenText = "Change Change dividends from unit trusts or investment companies"
    val dividendsOtherAmountHiddenText = "Change Change amount of dividends from unit trusts or investment companies"
    val stockDividendsStatusHiddenText = "Change Change stock dividends"
    val stockDividendsAmountHiddenText = "Change Change value of stock dividends"
    val redeemableSharesStatusHiddenText = "Change Change free or redeemable shares"
    val redeemableSharesAmountHiddenText = "Change Change value of free or redeemable shares"
    val closeCompanyLoanStatusHiddenText = "Change Change close company loan written off or released"
    val closeCompanyLoanAmountHiddenText = "Change Change value of close company loan written off or released"
  }
  ...
  object AllExpectedWelsh extends CommonExpectedResults {
    ...
    val dividendsFromStocksAndSharesHiddenText = "Newid Newid difidendau o stociau a chyfranddaliadau"
    val dividendsStatusHiddenText = "Newid Newid difidendau o gwmnïau yn DU"
    val dividendsAmountHiddenText = "Newid Newid swm y difidendau o gwmnïau yn DU"
    val dividendsOtherStatusHiddenText = "Newid Newid difidendau o ymddiriedolaethau unedol neu gwmnïau buddsoddi"
    val dividendsOtherAmountHiddenText = "Newid Newid swm y difidendau o ymddiriedolaethau unedol neu gwmnïau buddsoddi"
    val stockDividendsStatusHiddenText = "Newid Newid difidendau stoc"
    val stockDividendsAmountHiddenText = "Newid Newid gwerth y difidendau stoc"
    val redeemableSharesStatusHiddenText = "Newid Newid difidendau adbryn neu ddifidendau sy’n rhad ac am ddim"
    val redeemableSharesAmountHiddenText = "Newid Newid gwerth y difidendau adbryn neu’r difidendau sy’n rhad ac am ddim"
    val closeCompanyLoanStatusHiddenText = "Newid Newid benthyciadau gan gwmnïau caeedig a ddilëwyd neu a ryddhawyd"
    val closeCompanyLoanAmountHiddenText = "Newid Newid gwerth benthyciadau gan gwmnïau caeedig a ddilëwyd neu a ryddhawyd"
