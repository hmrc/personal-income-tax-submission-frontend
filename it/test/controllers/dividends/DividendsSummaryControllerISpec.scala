...
class DividendsSummaryControllerISpec extends IntegrationTest with ViewHelpers with DividendsDatabaseHelper {
  ...
  object AllExpectedEnglish extends CommonExpectedResults {
    ...
    val dividendsFromStocksAndSharesHiddenText = "Change dividends from stocks and shares"
    val dividendsStatusHiddenText = "Change dividends from UK companies"
    val dividendsAmountHiddenText = "Change amount of dividends from UK companies"
    val dividendsOtherStatusHiddenText = "Change dividends from unit trusts or investment companies"
    val dividendsOtherAmountHiddenText = "Change amount of dividends from unit trusts or investment companies"
    val stockDividendsStatusHiddenText = "Change stock dividends"
    val stockDividendsAmountHiddenText = "Change value of stock dividends"
    val redeemableSharesStatusHiddenText = "Change free or redeemable shares"
    val redeemableSharesAmountHiddenText = "Change value of free or redeemable shares"
    val closeCompanyLoanStatusHiddenText = "Change close company loan written off or released"
  ...
  object AllExpectedWelsh extends CommonExpectedResults {
    ...
    val dividendsFromStocksAndSharesHiddenText = "Newid difidendau o stociau a chyfranddaliadau"
    val dividendsStatusHiddenText = "Newid difidendau o gwmnïau yn DU"
    val dividendsAmountHiddenText = "Newid swm y difidendau o gwmnïau yn DU"
    val dividendsOtherStatusHiddenText = "Newid difidendau o ymddiriedolaethau unedol neu gwmnïau buddsoddi"
    val dividendsOtherAmountHiddenText = "Newid swm y difidendau o ymddiriedolaethau unedol neu gwmnïau buddsoddi"
    val stockDividendsStatusHiddenText = "Newid difidendau stoc"
    val stockDividendsAmountHiddenText = "Newid gwerth y difidendau stoc"
    val redeemableSharesStatusHiddenText = "Newid difidendau adbryn neu ddifidendau sy’n rhad ac am ddim"
    val redeemableSharesAmountHiddenText = "Newid gwerth y difidendau adbryn neu’r difidendau sy’n rhad ac am ddim"
    val closeCompanyLoanStatusHiddenText = "Newid benthyciadau gan gwmnïau caeedig a ddilëwyd neu a ryddhawyd"
