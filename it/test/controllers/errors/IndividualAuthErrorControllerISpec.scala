...
package test.controllers.errors
...
class IndividualAuthErrorControllerISpec extends IntegrationTest with ViewHelpers {
  ...
  object CommonExpectedCY extends CommonExpectedResults {
    ...
    val pageContent: String = "Mae’n rhaid i chi cofrestru am y cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm cyn i chi allu bwrw golwg ar y dudalen hon."
    val linkContent: String = "cofrestru am y cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm"
    val linkHref: String = "https://www.gov.uk/guidance/sign-up-your-business-for-making-tax-digital-for-income-tax"
  }
