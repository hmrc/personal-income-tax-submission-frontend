...
class AccountsControllerISpec extends IntegrationTest with InterestDatabaseHelper {
  ...
  val untaxedUrl = s"$startUrl/$taxYear/interest/untaxed-uk-interest-account-summary"
  val taxedUrl = s"$startUrl/$taxYear/interest/taxed-uk-interest-account-summary"
