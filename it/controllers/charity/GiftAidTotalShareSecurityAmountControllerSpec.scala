...
class GiftAidTotalShareSecurityAmountControllerSpec extends IntegrationTest with ViewHelpers {
  ...
  object ExpectedErrorsEn {
    ...
    val incorrectFormatIndividual = "Enter the value of shares or securities you donated to charity in the correct format"

    val tooLongAgent = "The value of your client’s shares or securities must be less than £100,000,000,000"
    val emptyFieldAgent = "Enter the value of shares or securities your client donated to charity"
    val incorrectFormatAgent = "Enter the value of shares or securities your client donated to charity in the correct format"
