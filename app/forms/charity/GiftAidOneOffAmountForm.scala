...
object GiftAidOneOffAmountForm {

  val giftAidOneOffAmount: String = "amount"

  def giftAidOneOffAmountForm(isAgent: Boolean): Form[BigDecimal] = Form(
    giftAidOneOffAmount -> currency(
