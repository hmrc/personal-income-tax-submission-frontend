...
@Singleton
class QuestionsJourneyValidator @Inject()(appConfig: AppConfig) {

  def validate[M : QuestionsJourney](currentPage: Call, cyaOpt: Option[M], taxYear: Int)(block: => Result): Result = {
