...
import controllers.dividends.UkDividendsAmountController
import controllers.dividendsSplit.UkDividendsAmountSplitController
import play.api.mvc.{Action, AnyContent}

class UkDividendsAmountBaseController @Inject()(linearController: UkDividendsAmountController,
                                                     splitController: UkDividendsAmountSplitController,
                                                     appConfig: AppConfig) {
