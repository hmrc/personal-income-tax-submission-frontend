...
object GetStockDividendsSessionHttpParser extends APIParser {
  type GetStockDividendsSessionResponse = Either[APIErrorModel, Option[StockDividendsUserDataModel]]

  override val parserName: String = "GetStockDividendsSessionHttpParser"
  override val service: String = "personal-income-tax-submission-frontend"

  implicit object GetGainsDataHttpReads extends HttpReads[GetStockDividendsSessionResponse] {

    override def read(method: String, url: String, response: HttpResponse): GetStockDividendsSessionResponse = {
      response.status match {
        case OK => response.json.validate[StockDividendsUserDataModel].fold[GetStockDividendsSessionResponse](
