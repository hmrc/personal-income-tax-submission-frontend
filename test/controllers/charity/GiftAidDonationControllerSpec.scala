...
class GiftAidDonationControllerSpec extends UnitTestWithApp {

  lazy val controller = new GiftAidDonationsController()(
    mockMessagesControllerComponents,
    authorisedAction,
    app.injector.instanceOf[GiftAidDonationView],
    mockAppConfig
  )
