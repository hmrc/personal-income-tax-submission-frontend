  ...
  ".fromSession" should {
    ...
    "return an InterestPriorSubmission" when {
      ...
      "there is prior data in session" in {
        val user = User[AnyContent]("1234567890", None, "AA123456A")(fakeRequest.withSession(
    ...
    "return a None" when {
      ...
      "there is no prior data in session" in {
        val user: User[AnyContent] = User[AnyContent]("1234567890", None, "AA123456A")(fakeRequest)
