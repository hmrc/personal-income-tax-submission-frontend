...
class InterestAccountsViewSpec extends ViewTest {
  ...
  val youMustTellUntaxedIndividual = "You must tell us about all your accounts with untaxed UK interest."
  val youMustTellUntaxedAgent = "You must tell us about all your client’s accounts with untaxed UK interest."
  val youMustTellTaxedIndividual = "You must tell us about all your accounts with taxed UK interest."
  val youMustTellTaxedAgent = "You must tell us about all your client’s accounts with taxed UK interest."
  val yesText = "Yes"
  val noText = "No"
  ...
  "InterestAccountsView when untaxed in English" should {
    "render with 1 row" when {
      ...
      "as an individual there is a single untaxed account passed in that is not a prior submission" which {
        ...
        textOnPageCheck(youMustTellUntaxedIndividual, youMustTellSelector)
      ...
      "as an agent there is a single untaxed account passed in that is a prior submission" which {
        ...
        textOnPageCheck(doYouNeedText, doYouNeedSelector)
        textOnPageCheck(youMustTellUntaxedAgent, youMustTellSelector)
        radioButtonCheck(yesText, 1)
        radioButtonCheck(noText, 2)
        buttonCheck(continueText, continueSelector)
        formPostLinkCheck(controllers.interest.routes.AccountsController.submit(taxYear, UNTAXED).url, continueFormSelector)
      ...
      "as an individual the radio button form is not selected" which {
        val yesNoForm =
    ...
    "render with 2 rows" when {
      ...
      "as an individual there are two accounts passed in, one new account and one prior" which {
  ...
  "InterestAccountsView when taxed in English" should {
    ...
    "render with 1 row" when {
      ...
      "as an individual there is a single taxed account passed in that is not a prior submission" which {
        ...
        textOnPageCheck(doYouNeedText, doYouNeedSelector)
        textOnPageCheck(youMustTellTaxedIndividual, youMustTellSelector)
        radioButtonCheck(yesText, 1)
        radioButtonCheck(noText, 2)
        buttonCheck(continueText, continueSelector)
      ...
      "as an agent there is a single taxed account passed in that is a prior submission" which {
        ...
        textOnPageCheck(doYouNeedText, doYouNeedSelector)
        textOnPageCheck(youMustTellTaxedAgent, youMustTellSelector)
        radioButtonCheck(yesText, 1)
        radioButtonCheck(noText, 2)
        buttonCheck(continueText, continueSelector)
        formPostLinkCheck(controllers.interest.routes.AccountsController.submit(taxYear, TAXED).url, continueFormSelector)
  ...
  "InterestAccountsView when untaxed in Welsh" should {
    "render with 1 row" when {
      ...
      "as an individual there is a single untaxed account passed in that is a prior submission" which {
      ...
      "as an agent the radio button form is not selected" which {
        val yesNoForm =
          YesNoForm.yesNoForm("Select yes if you received untaxed interest from the UK").bind(Map("value" -> ""))
        lazy val result = view(yesNoForm, taxYear, Seq(
          InterestAccountModel(None, "Bank of UK", 9001.00, Some("qwerty"))
        ), UNTAXED, isAgent = true)(fakeRequest, welshMessages, mockAppConfig)
        implicit val document: Document = Jsoup.parse(result.body)
  ...
  "InterestAccountsView when taxed in Welsh" should {
    ...
    "render with 1 row" when {
      ...
      "as an individual there is a single taxed account passed in that is a prior submission" which {
